      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl font-bold mt-5 text-[#1e3a8a]">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {courses.filter(c => c.featured).map((course, i) => {
              ...
              return (
                ...
                >
                  <div className="p-8 rounded-2xl bg-white shadow-sm hover:shadow-xl transition">

                    {/* TOP */}
                    <div className="flex justify-between items-start mb-5">
                      <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br from-[#2563eb] to-[#22c1dc]">
                      ...
                      <span className="text-xs bg-[#2563eb] text-white px-3 py-1 rounded-full">
                        {course.badge}
                      </span>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-[#2563eb] text-white font-semibold hover:bg-[#1e40af] transition flex items-center justify-center gap-2"
                    >
                ...
                >
                  <div className="p-8 rounded-2xl bg-white shadow-sm hover:shadow-xl transition">
                                ...
                                <a
                                  ...
                                  bg-gradient-to-r from-[#2563eb] to-[#22c1dc] text-white"
                                >
                                  Talk to Mentor <ArrowRight />
                                </a>
                    </div>
