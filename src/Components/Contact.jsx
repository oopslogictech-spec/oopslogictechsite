...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    { icon: Mail, label: 'Email', value: 'contact@oopslogic.com', link: 'mailto:contact@oopslogic.com' },
    { icon: MapPin, label: 'Location', value: 'Coimbatore, Tamil Nadu', link: '#' },
    { icon: Clock, label: 'Working Hours', value: 'Mon - Sat: 9AM - 7PM', link: '#' },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-white/80 mb-8 leading-relaxed">
              Reach out for courses, projects, or career guidance. Our team is ready to assist you.
            </p>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full border border-gray-200 rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#2563eb]"
              >
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-[#2563eb] to-[#22c1dc] text-white font-semibold shadow-lg hover:scale-[1.02] transition-all duration-300"
              >
                Send Message
              </button>
